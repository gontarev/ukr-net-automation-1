...
public class ImmutableInteractions extends TestBase {
    ...
    public void getAttributeTest() {
        ...
        System.out.println("GetAttr: " + textInput.getAttribute("outerHTML"));
    ...
    public void getTextTest() {
        ...
        System.out.println("GetAttrForDiv: " + driver.findElement(By.id("div")).getAttribute("textContent"));
    ...
    public void getCssValues() {
        ...
        By text = By.cssSelector("#btnEnableRichText");
