...
public class PetApiTest {
    ...
    @Test
    public void AddPet() {
        Pet body = new Pet().tags(new ArrayList<>()).id(123l).name("asda").status(Pet.StatusEnum.PENDING);
        api.addPet()
                .body(body).execute(r -> PetAssert.assertThat(new Gson().fromJson(r.getBody().print(), Pet.class)).isEqualTo(body));
